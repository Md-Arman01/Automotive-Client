const MarqueeCard = () => {
  return (
    <div className="flex gap-5">
        {/* 1 */}
        <div className="w-96 p-5 border-2 rounded-lg">
            ...
            <p className="text-xs text-gray-500 mt-5">Blown away. The theme is beautiful, well coded, and seriously top notch in terms of quality. I had some issues with the theme (my preference not issues in the code) and they were quick to jump in and help. They replied super fast and fixed my issues asap. Thank you for building such a great theme - will definitely be back when I need a refreshed website.</p>
        </div>
        {/* 2 */}
        <div className="w-96 p-5 border-2 rounded-lg">
            <div className="flex items-center gap-5">
