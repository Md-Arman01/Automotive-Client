  ...
  return (
    <div className='overflow-x-hidden'>
      <div className="relative grid h-[40rem] w-full flex-col items-end justify-center overflow-hidden bg-white bg-clip-border text-center">
        ...
        data-aos-once="false"
         className="absolute bottom-44 p-6 px-6 py-24 md:px-12">
          <h2 className=" block font-rancho text-6xl font-semibold  leading-[1.5] tracking-normal bg-gradient-to-t from-[#fa0844] to-[#fa6d63] text-transparent bg-clip-text antialiased">
